...
class Construct_Dataset(Dataset):
    ...
    def __getitem__(self, item):
        ...
        add_img = cv2.addWeighted(imgs, 1, mask_s, 1, 0)
        ...
        mask_m = cv2.applyColorMap(mask_m, cv2.COLORMAP_HOT)
        add_img = cv2.addWeighted(imgm, 1, mask_m, 1, 0)
        ...
        mask_l = cv2.applyColorMap(mask_l, cv2.COLORMAP_HOT)
        add_img = cv2.addWeighted(imgl, 1, mask_l, 1, 0)
